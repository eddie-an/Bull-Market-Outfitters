...
export default function Cart() {
  const {itemsInCart, handleQuantityChangeInCart, handleRemoveFromCart, setIsCartDisplayed} = useContext(CartContext);
                          ...
                          <div className="flex-1 ml-4">
                            ...
                            <div className="flex justify-start items-center mb-4 mt-2">
                              ...
                              <input
                                type="number"
                                value={item.quantity}
                                onChange={(e) => handleQuantityChangeInCart(item.product._id, e.target.value)}
                                min="1"
