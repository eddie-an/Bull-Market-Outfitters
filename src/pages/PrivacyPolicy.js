...
const PrivacyPolicy = () => {
    ...
    <>
        <div className="p-8 mx-auto max-w-4xl">
            ...
            <ul className="list-disc pl-5 mb-4 text-xs md:text-base">
                <li>Name and Contact Data</li>
                <li>Payment Information</li>
                <li>Preferences</li>
            </ul>
            
            <h2 className="text-xl md:text-2xl font-semibold mb-2">How We Use Your Information</h2>
            <p className="mb-4 text-xs md:text-base">
                We use personal information collected via our website for a variety of business purposes described below. We process your personal information for these purposes in reliance on our legitimate business interests, in order to enter into or perform a contract with you, with your consent, and/or for compliance with our legal obligations.
            </p>
            
            <h3 className="text-lg md:text-xl font-semibold mb-2">Examples of Use</h3>
            <ul className="list-disc pl-5 mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Sharing Your Information</h2>
            <p className="mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Security of Your Information</h2>
            <p className="mb-4 text-xs md:text-base">
                We aim to protect your personal information through a system of organizational and technical security measures.
            </p>
            
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Your Privacy Rights</h2>
            <p className="mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Changes to This Policy</h2>
            <p className="mb-4 text-xs md:text-base">
