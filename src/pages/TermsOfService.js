  ...
  return (
    <>
        <div className="p-8 mx-auto max-w-4xl">
            <h1 className="text-2xl md:text-3xl font-bold mb-4">Terms of Service</h1>
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Use of Service</h2>
            <p className="mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Accounts</h2>
            <p className="mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Termination</h2>
            <p className="mb-4 text-xs md:text-base">
                We may terminate or suspend your account and bar access to the Service immediately, without prior notice or liability, under our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of the Terms.
            </p>
            
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Limitation of Liability</h2>
            <p className="mb-4 text-xs md:text-base">
            ...
            <h2 className="text-xl md:text-2xl font-semibold mb-2">Governing Law</h2>
            <p className="mb-4 text-xs md:text-base">
